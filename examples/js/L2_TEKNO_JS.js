...
/*
	kodingan teo yang ada di sini dipindah ke per-ruangan
*/

// UNCOMMENT FOR MQTT VIO ACTIVATION //
...
function addCube2()  {
	...
	var geometry = new THREE.BoxGeometry( 0.58, 0.09, 1.1 );
	var material = new THREE.MeshBasicMaterial( { color: 0x003077, opacity: 0.0, transparent: true } );
	cube2 = new THREE.Mesh( geometry, material );
	cube2.position.set(2.03,0.03,-0.9);
	// cube2.position.set(2.03,0.03,0.06);
	scene.add( cube2 );
	takeObject(cube2);
	takeObject3(cube2);
	/*
...
function addCube3()  {
	...
	//-1.11,0,0.27
	var geometry = new THREE.BoxGeometry( 0.84, 0.09, 0.32 );
	var material = new THREE.MeshBasicMaterial( { color: 0x003077, opacity: 0.0, transparent: true } );
	cube3 = new THREE.Mesh( geometry, material );
	cube3.position.set(1.36,0.03,-1.28);
	scene.add( cube3 );
	takeObject(cube3);
	takeObject4(cube3);
	/*
...
function addCube4()  {
	...
	//-1.11,0,0.27
	var geometry = new THREE.BoxGeometry( 0.7, 0.09, 0.32 );
	var material = new THREE.MeshBasicMaterial( { color: 0x003077, opacity: 0.0, transparent: true } );
	cube4 = new THREE.Mesh( geometry, material );
	cube4.position.set(0.51,0.03,-1.28);
	scene.add( cube4 );
	takeObject(cube4);
	takeObject5(cube4);
	/*
...
function addCube5()  {
	...
	if ( cube5 !== undefined ) {
		...
		cube5.geometry.dispose();
		scene.remove( cube5 );

	}
	//-1.11,0,0.27
	var geometry = new THREE.BoxGeometry( 1.02, 0.09, 0.32 );
	var material = new THREE.MeshBasicMaterial( { color: 0x003077, opacity: 0.0, transparent: true } );
	cube5 = new THREE.Mesh( geometry, material );
	cube5.position.set(-0.45,0.03,-1.28);
	scene.add( cube5 );
	takeObject(cube5);
	takeObject6(cube5);
	/*
...
function addCube6()  {
	...
	if ( cube6 !== undefined ) {
		...
		cube6.geometry.dispose();
		scene.remove( cube6 );

	}
	//-1.11,0,0.27
	var geometry = new THREE.BoxGeometry( 0.85, 0.09, 0.41 );
	var material = new THREE.MeshBasicMaterial( { color: 0x003077, opacity: 0.0, transparent: true } );
	cube6 = new THREE.Mesh( geometry, material );
	cube6.position.set(-1.36,0.03,-1.25);
	scene.add( cube6 );
	takeObject(cube6);
	takeObject7(cube6);
	/*
...
function addCube7()  {
	...
	if ( cube7 !== undefined ) {
		...
		cube7.geometry.dispose();
		scene.remove( cube7 );

	}
	//-1.11,0,0.27
	var geometry = new THREE.BoxGeometry( 0.54, 0.09, 1.01 );
	var material = new THREE.MeshBasicMaterial( { color: 0x003077, opacity: 0.0, transparent: true } );
	cube7 = new THREE.Mesh( geometry, material );
	cube7.position.set(-2.04,0.03,-0.93);
	scene.add( cube7 );
	takeObject(cube7);
	takeObject8(cube7);
	/*
...
function onDocumentMouseDown(event) {
	...
	var intersects6 = raycaster.intersectObject( object6 );
	var intersects7 = raycaster.intersectObject( object7 );
	var intersects8 = raycaster.intersectObject( object8 );
	...
	if (intersects2.length > 0) {
			...
			if ( isShiftDown ) {
				...
				if (camStat == 0)	{
					clickStat = 1;
					camera.position.set( 3, 1.1, 0 );
					xCam = 2, zCam = 0, yCam = 0;
					//dat.GUI.toggleHide();
	...
	if (intersects3.length > 0) {
			...
			if ( isShiftDown ) {
				...
				if (camStat == 0)	{
					clickStat = 1;
					camera.position.set( 3, 1.1, -0.9 );
					xCam = 2, zCam = -0.9, yCam = 0;
					//dat.GUI.toggleHide();
					...
					//buttons
					for(let i=0;i<10;i++){
						document.getElementById(''+(i+1)).innerHTML = ACStr[i+9];
						// document.getElementById(''+(i+1)).onclick = function(){
	...
	if (intersects4.length > 0) {
			...
			if ( isShiftDown ) {
				...
				if (camStat == 0)	{
					clickStat = 1;
					camera.position.set( 1.3, 1.1, -0.5 );
					xCam = 1.3, zCam = -1.3, yCam = 0;
					//dat.GUI.toggleHide();
					//setupGui3();
					hvac1b();
					hvac2b();
					...
					//buttons
					for(let i=0;i<2;i++){
						document.getElementById(''+(i+1)).innerHTML = ACStr[i+19];
						// document.getElementById(''+(i+1)).onclick = function(){
	...
	if (intersects5.length > 0) {
			...
			if ( isShiftDown ) {
				...
				if (camStat == 0)	{
					clickStat = 1;
					camera.position.set( 0.5, 1.1, -0.5 );
					xCam = 0.5, zCam = -1.3, yCam = 0;
					//dat.GUI.toggleHide();
					//setupGui4();
					hvac1c();
					hvac2c();
					...
					//buttons
					for(let i=0;i<6;i++){
						//belum di set sama teo
						//document.getElementById(''+(i+1)).innerHTML = ACStr[i+19];
						//document.getElementById(''+(i+1)).onclick = function(){	onOffReq(ACStr[i+19],i+19); }
						document.getElementById(''+(i+1)).style.visibility = 'visible';
					}
	...
	if (intersects6.length > 0) {
			intersect = intersects6[0];
			//alert(selectedObject);
			if ( isShiftDown ) {
				if ( intersect.object != plane ) {
					scene.remove( intersect.object );
					object6.splice( object6.indexOf( intersect.object ), 1 );
				}
				...
				if (camStat == 0)	{
					clickStat = 1;
					camera.position.set( -0.45, 1.1, -0.5 );
					xCam = -0.45, zCam = -1.3, yCam = 0;
					//dat.GUI.toggleHide();
					//setupGui4();
					// hvac1c();
					// hvac2c();
	...
	if (intersects7.length > 0) {
			intersect = intersects7[0];
			//alert(selectedObject);
			if ( isShiftDown ) {
				if ( intersect.object != plane ) {
					scene.remove( intersect.object );
					object7.splice( object7.indexOf( intersect.object ), 1 );
				}
				...
				if (camStat == 0)	{
					clickStat = 1;
					camera.position.set( -1.4, 1.1, -0.5 );
					xCam = -1.4, zCam = -1.3, yCam = 0;
					//dat.GUI.toggleHide();
					//setupGui4();
					// hvac1c();
					// hvac2c();
					...
					document.getElementById('title6').style.visibility = 'visible';
	...
	if (intersects8.length > 0) {
			intersect = intersects8[0];
			//alert(selectedObject);
			if ( isShiftDown ) {
				if ( intersect.object != plane ) {
					scene.remove( intersect.object );
					object8.splice( object8.indexOf( intersect.object ), 1 );
				}
				...
				if (camStat == 0)	{
					...
					document.getElementById('title7').style.visibility = 'visible';
...
function init() {
	...
	function rect()	{
		loader.load( './models/stl/tekno/teknopart2/L2_RECT.stl', function ( geometry ) {
	...
	function walls()	{
		loader.load( './models/stl/tekno/teknopart2/L2_WALLS.stl', function ( geometry ) {
	...
	function takeObject6(xx) {
		object6 = xx;
		objArray6.push(xx);
		//selected = xx;
	}

	function takeObject7(xx) {
		object7 = xx;
		objArray7.push(xx);
		//selected = xx;
	}

	function takeObject8(xx) {
		object8 = xx;
		objArray8.push(xx);
		//selected = xx;
	}
	...
	function updatex() {
		...
		var intersectsText5 = ray.intersectObjects(objArray6);
		var intersectsText6 = ray.intersectObjects(objArray7);
		var intersectsText7 = ray.intersectObjects(objArray8);
		...
		if (intersectsText1.length > 0) {
			...
			if (intersectsText1[0].object != INTERSECTED) {
				...
				if (camStat == 0)	{
					...
					document.getElementById('title3').style.visibility = 'hidden';
					document.getElementById('title4').style.visibility = 'hidden';
					document.getElementById('title5').style.visibility = 'hidden';
					document.getElementById('title6').style.visibility = 'hidden';
					document.getElementById('title7').style.visibility = 'hidden';
				}
				//addCube(0.5);
			}
		}
		...
		else if (intersectsText5.length > 0) {
			// if the closest object intersected is not the currently stored intersection object
			if (intersectsText5[0].object != INTERSECTED) {
				// restore previous intersection object (if it exists) to its original color
				if (INTERSECTED)
					//INTERSECTED.material.color.setHex(INTERSECTED.currentHex);
					INTERSECTED.material.opacity = INTERSECTED.currentOpacity;
				...
				// store reference to closest object as current intersection object
				INTERSECTED = intersectsText5[0].object;
				// store color of closest object (for later restoration)
				//INTERSECTED.currentHex = INTERSECTED.material.color.getHex();
				INTERSECTED.currentOpacity = INTERSECTED.material.opacity;
				// set a new color for closest object
		...
		else if (intersectsText6.length > 0) {
			// if the closest object intersected is not the currently stored intersection object
			if (intersectsText6[0].object != INTERSECTED) {
				// restore previous intersection object (if it exists) to its original color
				if (INTERSECTED)
					//INTERSECTED.material.color.setHex(INTERSECTED.currentHex);
					INTERSECTED.material.opacity = INTERSECTED.currentOpacity;
				...
				// store reference to closest object as current intersection object
				INTERSECTED = intersectsText6[0].object;
				// store color of closest object (for later restoration)
				//INTERSECTED.currentHex = INTERSECTED.material.color.getHex();
				INTERSECTED.currentOpacity = INTERSECTED.material.opacity;
				// set a new color for closest object
		...
		else if (intersectsText7.length > 0) {
			// if the closest object intersected is not the currently stored intersection object
			if (intersectsText7[0].object != INTERSECTED) {
				// restore previous intersection object (if it exists) to its original color
				if (INTERSECTED)
					//INTERSECTED.material.color.setHex(INTERSECTED.currentHex);
					INTERSECTED.material.opacity = INTERSECTED.currentOpacity;
				...
				// store reference to closest object as current intersection object
				INTERSECTED = intersectsText7[0].object;
				// store color of closest object (for later restoration)
				//INTERSECTED.currentHex = INTERSECTED.material.color.getHex();
				INTERSECTED.currentOpacity = INTERSECTED.material.opacity;
				// set a new color for closest object
