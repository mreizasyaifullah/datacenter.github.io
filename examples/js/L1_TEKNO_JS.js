...
function addCube2()  {
	...
	cube2.position.set(0.25,0.03,-0.02);
	scene.add( cube2 );
	takeObject(cube2);
	takeObject3(cube2);
	/*
...
function addCube3()  {
	...
	cube3.position.set(-0.24,0.03,-0.02);
	scene.add( cube3 );
	takeObject(cube3);
	takeObject4(cube3);
	/*
...
function addCube4()  {
	...
	cube4.position.set(-0.73,0.03,-0.02);
	scene.add( cube4 );
	takeObject(cube4);
	takeObject5(cube4);
	/*
